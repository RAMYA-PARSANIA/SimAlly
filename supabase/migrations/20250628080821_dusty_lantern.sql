...
BEGIN
  ...
  INSERT INTO tasks (id, title, description, status, priority, due_date, project_id, estimated_hours, story_points, tags, created_by) VALUES
    ...
    ('44444444-aaaa-bbbb-cccc-dddddddddddd', 'Build analytics dashboard', 'Real-time data visualization and reporting', 'in_progress', 'critical', '2024-04-10', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 80.0, 21, ARRAY['frontend', 'analytics'], user_id),
