/*
  # Demo Workspace Data Population

  1. New Data
    - Creates departments, projects, tasks, channels, and messages
    - Links data to existing user accounts (CEO, Engineer, Designer, Marketing)
    - Generates realistic project timelines, tasks, and communications
    - Populates analytics with meaningful metrics
  
  2. Security
    - Maintains all RLS policies
    - Ensures proper user associations for all data
  
  3. Demo Features
    - Complete workspace environment for demonstration
    - Realistic project management workflow
    - Communication channels with sample conversations
...
BEGIN
  ...
  INSERT INTO task_comments (task_id, user_id, content) VALUES
    ...
    ('t0002114-2222-2222-2222-222222222222', engineer_id, 'Looks fantastic! I'll start implementing it right away.'),
    ...
    ('t0003111-3333-3333-3333-333333333333', ceo_id, 'I like option 2 and 3. Let's refine those further.'),
  ...
  INSERT INTO messages (channel_id, sender_id, content, type, created_at) VALUES
    ...
    ('c0005555-5555-5555-5555-555555555555', engineer_id, 'These look fantastic! I'll start implementing them right away.', 'text', NOW() - INTERVAL '19 days' + INTERVAL '2 hours'),
