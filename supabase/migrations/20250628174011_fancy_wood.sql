/*
  # Secure Gmail Token Storage

  1. New Tables
    - `user_encryption_keys` - Store user-specific encryption keys
    - Update `gmail_tokens` table with encrypted fields

  2. Security
    - Implement proper encryption for sensitive data
    - Add secure token storage functions
...
-- Create policy for gmail_tokens
